...
while($row = mysqli_fetch_array($produk)){
	...
	$query = mysqli_query($conn,"SELECT sum(totalcases) AS jumlah FROM tb_covid19 
...
$produk = mysqli_query($conn,"SELECT * FROM tb_covid19");
while($row = mysqli_fetch_array($produk)){
	$query = mysqli_query($conn,"SELECT sum(totaldeaths) AS jumlah FROM tb_covid19 
...
$produk = mysqli_query($conn,"SELECT * FROM tb_covid19");
while($row = mysqli_fetch_array($produk)){
	$query = mysqli_query($conn,"SELECT sum(totalrecovered) AS jumlah FROM tb_covid19 
...
$produk = mysqli_query($conn,"SELECT * FROM tb_covid19");
while($row = mysqli_fetch_array($produk)){
	$query = mysqli_query($conn,"SELECT sum(activecases) AS jumlah FROM tb_covid19 
...
$produk = mysqli_query($conn,"SELECT * FROM tb_covid19");
while($row = mysqli_fetch_array($produk)){
	$query = mysqli_query($conn,"SELECT sum(totaltests) AS jumlah FROM tb_covid19 
